...
class DockerTool:
    def __init__(self, hostname, proto, api_version):
        ...
        #self.__killContainer = killContainer(self.endpoint, self.__getPath(ContainerOPS.MAIN.value, ContainerOPS.KILL.value))
...
if __name__=="__main__":
    tool = DockerTool("ip172-18-0-122-cuo5iv291nsg00ats64g-2376.direct.labs.play-with-docker.com", "http", "v1.43")
    request = CreateRequest("test-container", "httpd", "8081", "80/tcp","192.168.0.10", "test", "always", [])
